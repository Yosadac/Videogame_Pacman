...
/*	spastilla.setTexture(pastilla);
	...
	//SONIDO----------------------------------------------------------------
	/*if (!*/buffer.loadFromFile("pastilla_sound.wav");/*) {
    		return -1;
	}*/
	sound.setBuffer(buffer);
	
	
	/*if (!*/bufferInicio.loadFromFile("SONIDO-DE-INICIO-DEL-JUEGO-PACMAN-AUDIO-HD.wav");/*) {
    		return -1;
	}*/
	inicio.setBuffer(bufferInicio);
	
	/*if (!*/bufferMuerte.loadFromFile("Sonido - Pacman (Game Over).wav");/*) {
    		return -1;
	}*/
	muerte_pac.setBuffer(bufferMuerte);
	...
	pacar1.loadFromFile("pacman/pacman.mov.1.arr.png");		
	pacar2.loadFromFile("pacman/pacman.mov.2.arr.png");
	pacab1.loadFromFile("pacman/pacman.mov.1.abj.png");		
	pacab2.loadFromFile("pacman/pacman.mov.2.abj.png");
	pacd1.loadFromFile("pacman/pacman.mov.1.der.png");		
	pacd2.loadFromFile("pacman/pacman.mov.2.der.png");
	paci1.loadFromFile("pacman/pacman.mov.1.izq.png");		
	paci2.loadFromFile("pacman/pacman.mov.2.izq.png");
		
	pac3.loadFromFile("pacman/pacman.mov.3.png");
	
	spacar1.setTexture(pacar1);
	spacar2.setTexture(pacar2);
	spacab1.setTexture(pacab1);
	spacab2.setTexture(pacab2);
	spacd1.setTexture(pacd1);
	spacd2.setTexture(pacd2);
	spaci1.setTexture(paci1);
	spaci2.setTexture(paci2);
	spac3.setTexture(pac3);
	
	spacar1.setScale(0.035f,0.035f);
    	spacar2.setScale(0.035f,0.035f);
    	spacab1.setScale(0.035f,0.035f);
    	spacab2.setScale(0.035f,0.035f);
    	spacd1.setScale(0.035f,0.035f);
    	spacd2.setScale(0.035f,0.035f);
    	spaci1.setScale(0.035f,0.035f);
    	spaci2.setScale(0.035f,0.035f);
